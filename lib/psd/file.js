...
module.exports = (File = (function() {
  ...
  File = class File {
    static initClass() {
      ...
      for (let format of Object.keys(FORMATS || {})) { const info = FORMATS[format]; ((format, info) => {
        return this.prototype[`read${format}`] = function() { return this.readf(info.code, info.length)[0]; };
      })(format, info); }
